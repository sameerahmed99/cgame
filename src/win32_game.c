...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow) {
  Win32PlatformConfig = cg_get_requested_platform_config();
  ...
  u64 totalRequestedMemorySize = Win32PlatformConfig.RequestedTempMemorySize + Win32PlatformConfig.RequestedPersistentMemorySize;
...
ASSERT_NO_EVAL(gameMemory.PersistentMemory);
  ...
  gameMemory.TempMemory = (u8*)gameMemory.PersistentMemory + Win32PlatformConfig.RequestedPersistentMemorySize;


  gameMemory.PersistentMemorySize = Win32PlatformConfig.RequestedPersistentMemorySize;
  gameMemory.TempMemorySize = Win32PlatformConfig.RequestedTempMemorySize;
  ...
  Win32PlatformConfig.HalfScreenWidth = platform_get_client_screen_width()/2.0f;
  Win32PlatformConfig.HalfScreenHeight = platform_get_client_screen_height()/2.0f;
  Win32PlatformConfig.HalfRenderBufferWidth = Win32PlatformConfig.RenderResolutionWidth/2.0f;
  Win32PlatformConfig.HalfRenderBufferHeight = Win32PlatformConfig.RenderResolutionHeight/2.0f;
  ...
  win32_update_window_rect(hwnd);
    ...
    cg_init(&buffer, Win32PlatformConfig);
